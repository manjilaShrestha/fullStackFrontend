...
const DepartmentManager = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingId) {
        await privateAPI.put(`/departments/${editingId}`, formData);
      
      } else {
        // const { head, ...payload } = formData;
        console.log("Sending data to create:", formData);  // <--- Add it here

        await privateAPI.post("/departments", formData);
